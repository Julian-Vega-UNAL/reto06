...
class MainActivity : ComponentActivity() {
    ...
    override fun onResume() {
        super.onResume()
        mHumanMediaPlayer = MediaPlayer.create(applicationContext, R.raw.dio) // human.mp3
        mComputerMediaPlayer = MediaPlayer.create(applicationContext, R.raw.bot) // computer.mp3
    }
